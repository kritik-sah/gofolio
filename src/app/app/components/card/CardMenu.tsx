...
function CardMenu(props: { transparent?: boolean; vertical?: boolean }) {
  ...
  return (
        ...
        <button
          ...
          className={`flex items-center text-xl hover:cursor-pointer ${
            transparent
              ...
              : vertical
              ? "bg-none text-stone-700 dark:text-white"
              : "bg-lightPrimary p-2 text-brand-500 hover:bg-gray-100 dark:bg-stone-700 dark:text-white dark:hover:bg-white/20 dark:active:bg-white/10"
    ...
    >
      <div className="z-50 w-max rounded-xl bg-white px-4 py-3 text-sm shadow-xl shadow-shadow-500 dark:!bg-stone-700 dark:shadow-none">
