    ...
    >
      <div className="h-full w-full">
        <div className="relative w-full">
          ...
          >
            <div className="flex h-full w-full items-center justify-center rounded-full text-xl hover:bg-gray-50 dark:text-stone-900">
              {heart ? (
                <IoHeartOutline />
              ) : (
        ...
        <div className="mb-3 flex items-center justify-between px-1 md:flex-col md:items-start lg:flex-row lg:justify-between xl:flex-col xl:items-start 3xl:flex-row 3xl:justify-between">
          <div className="mb-2">
            <p className="text-lg font-bold text-stone-700 dark:text-white">
              {" "}
              {title}{" "}
            </p>
          ...
          <div className="flex flex-row-reverse md:mt-2 lg:mt-0">
            <span className="z-0 ml-px inline-flex h-8 w-8 items-center justify-center rounded-full border border-white bg-[#E0E5F2] text-xs text-stone-700 dark:!border-stone-800 dark:bg-gray-800 dark:text-white">
              +5
            </span>
            {bidders.map((avt, key) => (
              <span
                key={key}
                className="-mr-3 h-8 w-8 rounded-full border border-white dark:!border-stone-800"
              >
                <Image
                  width="2"
                  height="20"
