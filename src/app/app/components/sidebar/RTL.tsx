...
import Links from "@/app/app/components/Links";
...
import {
  ...
  renderTrack,
  renderView,
} from "@/app/app/components/scrollbar/Scrollbar";
          ...
          <div className="flex h-full flex-col justify-between">
            <div>
              ...
              <div className={`ml-[52px] mt-[44px] flex items-center `}>
                <div
                  className={`mr-1 mt-1 h-2.5 font-poppins text-[26px] font-bold uppercase text-stone-700 dark:text-white ${
                    mini === false
                      ? "block"
                      : mini === true && hovered === true
                      ? "block"
            ...
            <div className="mb-[30px] mt-[28px]">
              ...
              <div className="mt-5 flex items-center justify-center gap-3">
                ...
                >
                  <h4 className="text-base font-bold text-stone-700 dark:text-white">
                    Adela Parkson
                  </h4>
